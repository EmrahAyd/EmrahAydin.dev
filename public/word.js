...
function keyup1(){
    ...
    deneme1 = [a1.value.toLowerCase(),a2.value.toLowerCase(),a3.value.toLowerCase(),a4.value.toLowerCase(),a.value.toLowerCase()]
    ...
    function controler(harfi){            
            ...
            if ( harfi.value.toLowerCase() == kelime[i]){
                harfi.classList.add("yesil")  
                console.log("yeşil oldu" + i+harfi.value)            
            }

                else if(harfi.value.toLowerCase() == kelime[ (i + 1) % 7] || harfi.value == kelime[(i + 2) % 7] || harfi.value == kelime[(i + 3) % 7] || harfi.value == kelime[(i + 4) % 7]){            
...
//////////// 2
        function keyup2(){
            ...
            deneme1 = [b1.value.toLowerCase(),b2.value.toLowerCase(),b3.value.toLowerCase(),b4.value.toLowerCase(),b.value.toLowerCase()]
        ...
        function keyup3(){
                            ...
                            deneme1 = [c1.value.toLowerCase(),c2.value.toLowerCase(),c3.value.toLowerCase(),c4.value.toLowerCase(),c.value.toLowerCase()]
        ...
        function keyup4(){
                                    ...
                                    deneme1 = [d1.value.toLowerCase(),d2.value.toLowerCase(),d3.value.toLowerCase(),d4.value.toLowerCase(),d.value.toLowerCase()]
                ...
                function keyup5(){
                                            ...
                                            deneme1 = [e1.value.toLowerCase(),e2.value.toLowerCase(),e3.value.toLowerCase(),e4.value.toLowerCase(),e.value.toLowerCase()]
